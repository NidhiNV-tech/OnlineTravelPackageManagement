...
Design and implementation of a software system that allows travel agencies to maintain their travel packages' itinerary and passengers.
...
High Level Diagram and Low Level Diagram alongwith implementation in Java programming language and unit test cases for each class are added here. Junit framework is used for unit testing the classes.
